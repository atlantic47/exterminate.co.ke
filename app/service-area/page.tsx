      ...
      <section className="py-16 bg-[#fbf7f0] border-b border-neutral-200">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          ...
          <p className="text-neutral-600 text-lg leading-relaxed mb-4">
            Kenya's diverse geography — from humid coastal cities to the cool central highlands and arid northern counties — means pest pressures vary significantly by region. A coastal hotel in Mombasa faces different challenges than a Nairobi apartment block or a Nakuru grain store. High humidity properties also experience accelerated fungal growth, making reliable <a href="https://moldguardkenya.co.ke/" target="_blank" rel="noopener noreferrer" className="text-primary font-semibold underline hover:text-primary/80">mold treatments</a> an essential part of coastal property maintenance.
          </p>
          <p className="text-neutral-600 text-lg leading-relaxed">
            Our regional teams are trained for area-specific pest profiles. Our Nairobi crews are experts in subterranean termite control, while our coastal teams specialise in humidity-driven cockroach and mosquito management. For areas where specialised knowledge matters, we also partner with providers like <a href="https://pestraid.co.ke/" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline font-semibold">Pestraid Kenya</a> to ensure every client gets the best expertise available. In regions dealing with relentless dampness, properties frequently also rely on <a href="https://moldguardkenya.co.ke/services" target="_blank" rel="noopener noreferrer" className="text-primary font-semibold underline hover:text-primary/80">mold remediation services</a> alongside their pest management routines.
          </p>
        </div>
      </section>
